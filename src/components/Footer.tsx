const Footer = () => {
  return (
    <div className="bg-black w-full flex items-center justify-center">
      <div className="grid grid-cols-1 lg:grid-cols-4 items-start relative w-full md:w-5/6 p-8  bg-black text-white">
        ...
        <div className="flex gap-2 lg:flex-col">
          ...
          <a
            className="flex items-center gap-2 font-extralight max-w-min"
            href="#"
          >
            <svg
          ...
          >
            ...
            <span className="hidden lg:flex">Dribble</span>
          </a>{" "}
          <a
            className="flex items-center gap-2 font-extralight max-w-min"
            href="#"
          >
            ...
            <span className="hidden lg:flex">Podcast</span>
          </a>
        </div>
